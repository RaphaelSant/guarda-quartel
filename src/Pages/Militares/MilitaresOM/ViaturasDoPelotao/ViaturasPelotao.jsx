...
export default function ViaturasDoPelotao() {
    ...
    const getViaturas = async () => {
        ...
        const viaturasCollectionRef = collection(db, "es_vtr_pelotao");
        try {
    ...
    const deleteViatura = async (id) => {
        ...
        const db = getFirestore();
        try {
            const viaturalDoc = doc(db, "es_vtr_pelotao", id);
    ...
    return (
        <>
            ...
            <h5 className="mt-4 mb-0 text-center d-print-none">
                Militares &gt; <strong style={{ color: "#008BD2" }}>Viaturas do pelotão</strong>
            </h5>
                                ...
                                <tr key={viaturas.id} className="align-middle">
                                    ...
                                    <td className="d-print-none">
                                        <div className="d-flex align-items-center justify-content-center gap-3">
                                            <div>
                                                <Link to={"/militares/viaturasDoPelotao/editarRegistro/" + id}>
